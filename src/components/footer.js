      ...
      <nav className="grid-x grid-padding-x grid-padding-y">
        <div className="cell medium-shrink large-5">
          <a className="footer-logo media_link" href="http://nyc.gov/planning">
            <img alt="NYC DCP" src="https://raw.githubusercontent.com/NYCPlanning/logo/master/dcp_logo_772.png" />
          </a>
        </div>
...
Status dashboard
            ...
            <div className="cell medium-auto large-auto">
              <h4 className="header-tiny">
Contact us
              </h4>
              <ul className="no-bullet">
                <li>
                  <a href="https://github.com/NYCPlanning?utf8=%E2%9C%93&amp;q=labs-">
Github
                  </a>
                </li>
                <li>
