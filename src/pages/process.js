        ...
        <StickyContainer className="grid-x grid-padding-x">
          ...
          <div className="cell large-8" id="page-content">
            ...
            <p>
              ...
              improvement, or something in between.
            </p>
            <a className="button no-margin" href="/submit-idea/">
              Submit an idea
            </a>
            ...
            <p>
              The Chief Operating Officer is presented with vetted project
              ideas, and makes a selection to add to the Labs pipeline based on
              feasibility, timing, and overall impact.
            </p>
            ...
            <h6> Everyone</h6>
            <p>
              When a project is selected, it’s added to the pipeline on our
              website. We try to identify at least 3 pipeline projects: The one
              we are currently building, and the next two that are on-deck.
            </p>
            <a className="button no-margin" href="/projects/">
              View our pipeline
            </a>
          </div>
        </StickyContainer>
