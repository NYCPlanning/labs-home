...
NYC Department of City Planning
            ...
            {' '}
(DCP) that embraces open technology, agile development, and user-centered design to build impactful products with NYC’s Urban Planners.
          </p>
          <p>
...
, and are applying a similar philosophy at a much smaller scale within our agency.
          </p>
        </div>
      </div>
...
Andy Cochran: Designer
          ...
          <div className="media-object">
            ...
            <div className="media-object-section">
              <p>
Andy joined the founding team of Planning Labs in July, 2017 after implementing New York City Council’s plan for digital inclusion and open government. As Design &amp; Creative Director at
                <a href="http://openplans.org/">
OpenPlans
                </a>
...
.
        ...
        <div className="cell large-6">
          <h3 id="taylor-mcginnis-intern">
Taylor McGinnis: Developer Intern
          </h3>
          <div className="media-object">
            <div className="media-object-section">
              {' '}
            ...
            <div className="media-object-section">
              <p>
Taylor is a GIS analyst currently acquiring a Certificate degree in GIS and Design from Pratt Institute. Originally an environmental geologist focused on urban sustainability, she is now expanding her mapping and data analysis skillsets to contribute to City planning projects.
              </p>
            </div>
          </div>
        </div>
...
Capital Planning Platform
            ...
            {' '}
using a 100% open source stack, a pitch was made to institutionalize modern development practices in the agency by establishing a service delivery unit within the Information Technology Division. Planning Labs’ mission would be to build lightweight impactful tools with the agency’s divisions as clients, and to be open, vocal, and inclusive about the modern technologies and processes used.
          </p>
        </div>
      </div>
